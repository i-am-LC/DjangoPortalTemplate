...
from django_portal_template.apps.users.forms import UserAdminChangeForm
...
from django_portal_template.apps.users.views import UserRedirectView, UserUpdateView, user_detail_view
